...
$(function () {
    $.ajax({
        ...
        success: function (json) {
            ...
            $('o_maingran changer1').html(`<img src="${json.btn3[0]}" alt="">
            <img src="${json.btn3[1]}" alt="" class="none">
            <img src="${json.btn3[2]}" alt="" class="none">
            <div class="logol">GranLusso</div>`);
            $('o_maingran changer2').html(`<img src="${json.btn3[3]}" alt="">
            <img src="${json.btn3[4]}" alt="" class="none">
            <img src="${json.btn3[5]}" alt="" class="none">
            <div class="logol">GranLusso</div>`);
